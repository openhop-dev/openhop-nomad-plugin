...
The plugin version is `0.1.3+test.2`. Replacing an existing installation of the same
...
```text
dist/openhop_nomad_plugin-0.1.3+test.2-py3-none-any.whl
```
